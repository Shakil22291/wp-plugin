<form id="myplugin-testimonial-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
	...
	<input type="hidden" name="nonce" value="<?= wp_create_nonce('testimonial_nonce'); ?>">
